...
def snp_data_frame():
    snp_file_name = 'C:\\Users\\nlark\\PycharmProjects\\Candlebox\\Test_Sample_Files\\' \
                    'GPGX-QS-23-27_20230321_060018_Export.csv'
    snp_df = pd.read_csv(snp_file_name, skiprows=17, header=0, encoding='unicode_escape')
    print(snp_df)
    return snp_df
